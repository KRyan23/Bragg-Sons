...
1. [Hover.css:](https://www.webdesignerdepot.com/2014/05/8-simple-css3-transitions-that-will-wow-your-users/)
    - Hover effects were used on all call to action buttons and text links when hovered over.
1. [Google Fonts:](https://fonts.google.com/)
    - Google fonts were used to import the "NotoSans" font into the style.css file which is used on all pages throughout the site.
